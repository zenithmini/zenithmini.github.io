  ...
  return (
    <main className="privacy-page">
      ...
      <div className="privacy-content">
        ...
        <section className="card">
          <h2>二、網站不主動蒐集的資料</h2>
          <p>本網站目前沒有會員系統，不要求輸入姓名、電話、電子郵件、身分證字號、銀行帳戶、券商帳戶或信用卡資料。分析與策略模擬服務只接收使用者輸入的股票代碼及測試期間，不接收本金、風險比例、自選股或虛擬交易紀錄。</p>
        </section>

        <section className="card">
          <h2>三、儲存在使用者裝置上的資料</h2>
          <p>為了保留自選股、資金與風險設定、字體大小、最近分析紀錄、策略模擬紀錄及短期市場快取，本網站會使用瀏覽器的 localStorage 與 Service Worker 快取。這些資料主要保存在使用者自己的裝置，可透過清除網站資料或瀏覽器快取移除。</p>
        </section>
